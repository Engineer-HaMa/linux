...
struct MappingData {
    // The RAII DMA mapping (unmaps on drop); `None` until `setup_prps_iter` maps.
    mapping: Option<mq::RequestDmaMapping>,
...
impl NvmeDevice {
    ...
    fn alloc_completion_queue<T: mq::Operations<RequestData = NvmeRequest> + Send>(
        ...
        Self::submit_sync_command(
            mq,
            NvmeCommand(::zerocopy::transmute!(NvmeCreateCq {
    ...
    fn alloc_submission_queue<T: mq::Operations<RequestData = NvmeRequest> + Send>(
        ...
        Self::submit_sync_command(
            mq,
            NvmeCommand(::zerocopy::transmute!(NvmeCreateSq {
    ...
    fn identify(
        ...
        Self::submit_sync_command(
            mq,
            NvmeCommand(::zerocopy::transmute!(NvmeIdentify {
    ...
    fn get_features(
        ...
        Self::submit_sync_command(
            mq,
            NvmeCommand(::zerocopy::transmute!(NvmeFeatures {
...
impl pci::Driver for NvmeDevice {
    ...
    fn unbind<'bound>(
        _pci_dev: &'bound pci::Device<device::Core<'_>>,
    ...
    fn probe<'bound>(
        pci_dev: &'bound pci::Device<device::Core<'_>>,
        _id: &'bound Self::IdInfo,
        ...
        pin_init::pin_init_scope(move || {
            ...
            let bar = pci_dev
                .iomap_region_sized::<8192>(0, c_str!("rnvme:controller"))?
                .into_devres()?;
